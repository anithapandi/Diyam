  		...
  		<div class="portimg">
  			<div class="containertitle">SPM/ICM</div>
  				<a target="_self" href="SPM.php">
    				<img src="Images/spm.png" alt="SPM/ICM"  width="320" height="200">
    			</a>	
    	</div>
  		...
  		<div class="portimg">
   			<div class="containertitle">Web Technologies</div>
   				<a target="_self" href="Web.php">
    				<img src="Images/web.png" alt="Web Technologies" width="320" height="200">
    			</a>	  
  		</div>
  		...
  		<div class="portimg">
  			<div class="containertitle">Business Integration Solutions</div>
  				<a target="_self" href="BI.php">
    				<img src="Images/BI2.png" alt="Data Integration" width="320" height="200">
    			</a>
  		</div>
	</div>
